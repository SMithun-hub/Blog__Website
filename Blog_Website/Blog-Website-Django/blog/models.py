...
class Category(models.Model):
    ...
    slug = models.SlugField(max_length=255, null=True, blank=True)  # Added max_length
...
class Blog(models.Model):
    ...
    slug = models.SlugField(max_length=255, null=True, blank=True)  # Increased max_length
